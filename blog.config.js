...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '等闲', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个江湖写手，副业是程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.wzy455.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '等闲, 博客，编程', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://pic1.imgdb.cn/item/68a13c7b58cb8da5c828b804.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
